...
public class QuizDataBaseHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable() {
        ...
        addQuestion(q2);
        Question q3 = new Question("Parmis ces déchets, lequel n'est pas recyclable ?", "Un sac plastique","Une boite à chaussures en carton","Un pot de confiture en verre",1,"Il faut privilégier les sac en carton",Category.TRI);
        addQuestion(q3);
        Question q4 = new Question("Parmis ces appareils électro-ménagers, lequel consomme le plus ?", "Le réfrigérateur","Le four","Le sèche linge",2,"Pensez à débrancher les appareils que vous n'utiliserez pas pendant longtemps",Category.CONSOMMATION);
        addQuestion(q4);
        ...
        addQuestion(q5);
        Question q6 = new Question("Depuis quand existe-t-il des lois en France qui protègent l'environnement ?", "1945","1975","2000",2,"Oui, seulement depuis 1975",Category.GENERALE);
        addQuestion(q6);
        ...
        addQuestion(q8);
        Question q9 = new Question("Qu'est ce que la symbiose ?", "Une algue","Une maladie due a un champignon","Une association à bénéfice réciproque",3,"Certains animaux dépendent très fortement de la symbiose",Category.GENERALE);
        addQuestion(q9);
        Question q10 = new Question("Dans lequels de ces objets trouve-t-on des métaux lourds ?", "Une brique de jus de fruits","Les boîtes de conserves","Les piles",3,"Dans ce cas, il s'agit du manganèse et du zinc contenus dans la pile",Category.GENERALE);
        addQuestion(q10);
        Question q11 = new Question("Quelle est la consommation moyenne d'eau par personne et par jour en France ?", "80 L","160 L","240 L",2,"Sachant que bains et douches réprésente 40% de notre consommation",Category.CONSOMMATION);
        addQuestion(q11);
        ...
        addQuestion(q12);
        Question q13 = new Question("Diminuer son chauffage de 1 degré permet de réaliser une economie de... ?", "3%","5%","7%",3,"Ce n'est pas négligable",Category.GENERALE);
        addQuestion(q13);
    ...
    private void addQuestion(Question question){
        ...
        //Insertion dans la catégorie GENERALE de la bdd si elle ne l'est pas directement
    ...
    // Liste questions de la catégorie
